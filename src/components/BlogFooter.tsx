        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            ...
            <p className="text-primary-foreground/70 text-sm leading-relaxed">
              Platform blog & majalah digital dengan konten berkualitas tinggi dari penulis-penulis terbaik.
            </p>
          </div>
          <div>
            <h4 className="font-heading font-semibold mb-3">Navigasi</h4>
            <div className="space-y-2 text-sm">
              <Link to="/" className="block text-primary-foreground/70 hover:text-primary-foreground transition-colors">Beranda</Link>
              <Link to="/login" className="block text-primary-foreground/70 hover:text-primary-foreground transition-colors">Masuk</Link>
            </div>
          </div>
          <div>
